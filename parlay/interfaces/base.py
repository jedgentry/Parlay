"""
Parlay interfaces allow generic control over different implementations. This generic control definition allows a host of widgets and scripts to interact with many different items, as long as the item ‘implements’ the interface
From wikipedia:

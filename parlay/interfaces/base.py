"""
Parlay interfaces allow generic control over different implementations. This generic control definition allows a host of widgets and scripts to interact with many different endpoints, as long as the endpoint ‘implements’ the interface
From wikipedia:
...
class ParlayInterface(zope.interface.Interface):
    """
    Base class that all parlay interfaces should inhirt from
    """
    pass